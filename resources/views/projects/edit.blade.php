<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('projects.update') }}" class="max-w-sm mx-auto">
                            @csrf
                            @method('PUT')
                    <!-- @if ($errors->any())
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $project->nombre)}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>

                <div class="mb-5">
                    <label for="status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-dark">Estado del Proyecto</label>
                    <select name="status" id="status" value="{{ old('status', $project->status)}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                ...
                <div class="mb-5">
                    <label for="quote_files" class="block mb-2 text-sm font-medium text-gray-900 dark:text-dark">Archivos de Cotización</label>
